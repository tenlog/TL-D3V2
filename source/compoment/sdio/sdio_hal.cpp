...
stc_sdcard_init_t stcCardInitCfg = {SdiocBusWidth4Bit, SdiocClk2M, SdiocHighSpeedMode, NULL,}; //SdiocNormalSpeedMode Normal speed will cause mainboard reboot when print speed > 200;
stc_sdcard_dma_init_t stcDmaInitCfg = {M4_DMA2, DmaCh2,};//M4_DMA2 DmaCh0 //by zyf dma2 ch0 is woriking...

...
bool    TMC2160Stepper::refl_step()      { TMC2160_n::IOIN_t r; r.sr = IOIN(); return r.refl_step; }
bool    TMC2160Stepper::refr_dir()       { TMC2160_n::IOIN_t r; r.sr = IOIN(); return r.refr_dir; }
bool    TMC2160Stepper::encb_dcen_cfg4() { TMC2160_n::IOIN_t r; r.sr = IOIN(); return r.encb_dcen_cfg4; }
bool    TMC2160Stepper::enca_dcin_cfg5() { TMC2160_n::IOIN_t r; r.sr = IOIN(); return r.enca_dcin_cfg5; }
bool    TMC2160Stepper::drv_enn()        { TMC2160_n::IOIN_t r; r.sr = IOIN(); return r.drv_enn; }
bool    TMC2160Stepper::dco_cfg6()       { TMC2160_n::IOIN_t r; r.sr = IOIN(); return r.dco_cfg6; }
uint8_t TMC2160Stepper::version()        { TMC2160_n::IOIN_t r; r.sr = IOIN(); return r.version; }

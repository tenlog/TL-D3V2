...
// by zyf
uint8_t TMC2130Stepper::toff()		{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.toff;	}// { CHOPCONF_t r{0}; r.sr = CHOPCONF(); return r.toff;	}
uint8_t TMC2130Stepper::hstrt()		{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.hstrt;	}//{ CHOPCONF_t r{0}; r.sr = CHOPCONF(); return r.hstrt;	}
uint8_t TMC2130Stepper::hend()		{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.hend;	}
//uint8_t TMC2130Stepper::fd()		{ CHOPCONF_t r{0}; r.sr = CHOPCONF(); return r.fd;		}
bool 	TMC2130Stepper::disfdcc()	{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.disfdcc;	}
bool 	TMC2130Stepper::rndtf()		{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.rndtf;	}
bool 	TMC2130Stepper::chm()		{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.chm;		}
uint8_t TMC2130Stepper::tbl()		{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.tbl;		}
bool 	TMC2130Stepper::vsense()	{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.vsense;	}
bool 	TMC2130Stepper::vhighfs()	{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.vhighfs;	}
bool 	TMC2130Stepper::vhighchm()	{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.vhighchm;}
uint8_t TMC2130Stepper::sync()		{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.sync;	}
uint8_t TMC2130Stepper::mres()		{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.mres;	}
bool 	TMC2130Stepper::intpol()	{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.intpol;	}
bool 	TMC2130Stepper::dedge()		{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.dedge;	}
bool 	TMC2130Stepper::diss2g()	{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.diss2g;	}

void TMC5160Stepper::diss2vs(bool B){ SET_REG(diss2vs); }
void TMC5160Stepper::tpfd(uint8_t B){ SET_REG(tpfd);	}
bool TMC5160Stepper::diss2vs()		{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.diss2vs; }
uint8_t TMC5160Stepper::tpfd()		{ CHOPCONF_t r; r.sr = CHOPCONF(); return r.tpfd;	}
...
//by zyf
uint8_t TMC2208Stepper::toff()		{ TMC2208_n::CHOPCONF_t r; r.sr = CHOPCONF(); return r.toff; 	} //{ TMC2208_n::CHOPCONF_t r{0}; r.sr = CHOPCONF(); return r.toff; 	}
uint8_t TMC2208Stepper::hstrt()		{ TMC2208_n::CHOPCONF_t r; r.sr = CHOPCONF(); return r.hstrt; 	}
uint8_t TMC2208Stepper::hend()		{ TMC2208_n::CHOPCONF_t r; r.sr = CHOPCONF(); return r.hend; 	}
uint8_t TMC2208Stepper::tbl()		{ TMC2208_n::CHOPCONF_t r; r.sr = CHOPCONF(); return r.tbl;	 	}
bool 	TMC2208Stepper::vsense()	{ TMC2208_n::CHOPCONF_t r; r.sr = CHOPCONF(); return r.vsense; 	}
uint8_t TMC2208Stepper::mres()		{ TMC2208_n::CHOPCONF_t r; r.sr = CHOPCONF(); return r.mres; 	}
bool 	TMC2208Stepper::intpol()	{ TMC2208_n::CHOPCONF_t r; r.sr = CHOPCONF(); return r.intpol; 	}
bool 	TMC2208Stepper::dedge()		{ TMC2208_n::CHOPCONF_t r; r.sr = CHOPCONF(); return r.dedge; 	}
bool 	TMC2208Stepper::diss2g()	{ TMC2208_n::CHOPCONF_t r; r.sr = CHOPCONF(); return r.diss2g; 	}
bool 	TMC2208Stepper::diss2vs()	{ TMC2208_n::CHOPCONF_t r; r.sr = CHOPCONF(); return r.diss2vs; 	}

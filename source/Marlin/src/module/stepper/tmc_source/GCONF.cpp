...
//by zyf
bool TMC2130Stepper::I_scale_analog()				{ GCONF_t r; r.sr = GCONF(); return r.i_scale_analog;		}  //{ GCONF_t r{0}; r.sr = GCONF(); return r.i_scale_analog;		}
bool TMC2130Stepper::internal_Rsense()				{ GCONF_t r; r.sr = GCONF(); return r.internal_rsense;		}
bool TMC2130Stepper::en_pwm_mode()					{ GCONF_t r; r.sr = GCONF(); return r.en_pwm_mode;			}
bool TMC2130Stepper::enc_commutation()				{ GCONF_t r; r.sr = GCONF(); return r.enc_commutation;		}
bool TMC2130Stepper::shaft() 						{ GCONF_t r; r.sr = GCONF(); return r.shaft;					}
bool TMC2130Stepper::diag0_error() 					{ GCONF_t r; r.sr = GCONF(); return r.diag0_error;			}
bool TMC2130Stepper::diag0_otpw() 					{ GCONF_t r; r.sr = GCONF(); return r.diag0_otpw;			}
bool TMC2130Stepper::diag0_stall() 					{ GCONF_t r; r.sr = GCONF(); return r.diag0_stall;			}
bool TMC2130Stepper::diag1_stall() 					{ GCONF_t r; r.sr = GCONF(); return r.diag1_stall;			}
bool TMC2130Stepper::diag1_index() 					{ GCONF_t r; r.sr = GCONF(); return r.diag1_index;			}
bool TMC2130Stepper::diag1_onstate() 				{ GCONF_t r; r.sr = GCONF(); return r.diag1_onstate;			}
bool TMC2130Stepper::diag1_steps_skipped() 			{ GCONF_t r; r.sr = GCONF(); return r.diag1_steps_skipped;	}
bool TMC2130Stepper::diag0_int_pushpull() 			{ GCONF_t r; r.sr = GCONF(); return r.diag0_int_pushpull;	}
bool TMC2130Stepper::diag1_pushpull()		 		{ GCONF_t r; r.sr = GCONF(); return r.diag1_poscomp_pushpull;}
bool TMC2130Stepper::small_hysteresis() 			{ GCONF_t r; r.sr = GCONF(); return r.small_hysteresis;		}
bool TMC2130Stepper::stop_enable() 					{ GCONF_t r; r.sr = GCONF(); return r.stop_enable;			}
bool TMC2130Stepper::direct_mode() 					{ GCONF_t r; r.sr = GCONF(); return r.direct_mode;			}
...
bool TMC5160Stepper::recalibrate()					{ GCONF_t r; r.sr = GCONF(); return r.recalibrate;	}
bool TMC5160Stepper::faststandstill()				{ GCONF_t r; r.sr = GCONF(); return r.faststandstill;	}
bool TMC5160Stepper::multistep_filt()				{ GCONF_t r; r.sr = GCONF(); return r.multistep_filt;	}
...
bool TMC2208Stepper::I_scale_analog()	{ TMC2208_n::GCONF_t r; r.sr = GCONF(); return r.i_scale_analog;		}
bool TMC2208Stepper::internal_Rsense()	{ TMC2208_n::GCONF_t r; r.sr = GCONF(); return r.internal_rsense;	}
bool TMC2208Stepper::en_spreadCycle()	{ TMC2208_n::GCONF_t r; r.sr = GCONF(); return r.en_spreadcycle;		}
bool TMC2208Stepper::shaft()			{ TMC2208_n::GCONF_t r; r.sr = GCONF(); return r.shaft;				}
bool TMC2208Stepper::index_otpw()		{ TMC2208_n::GCONF_t r; r.sr = GCONF(); return r.index_otpw;			}
bool TMC2208Stepper::index_step()		{ TMC2208_n::GCONF_t r; r.sr = GCONF(); return r.index_step;			}
bool TMC2208Stepper::pdn_disable()		{ TMC2208_n::GCONF_t r; r.sr = GCONF(); return r.pdn_disable;		}
bool TMC2208Stepper::mstep_reg_select()	{ TMC2208_n::GCONF_t r; r.sr = GCONF(); return r.mstep_reg_select;	}
bool TMC2208Stepper::multistep_filt()	{ TMC2208_n::GCONF_t r; r.sr = GCONF(); return r.multistep_filt;		}

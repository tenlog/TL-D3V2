 ...
 */
  ...
  #error "TEMP_0_PIN (required for TEMP_SENSOR_0) not defined for this board." //by zyf
  #endif
#elif EITHER(HAS_MULTI_HOTEND, HEATERS_PARALLEL) && !HAS_HEATER_1
  #ifndef ELECTROMAGNETIC_VALUE
  #error "HEATER_1_PIN is not defined. TEMP_SENSOR_1 might not be set, or the board (not EEB / EEF?) doesn't define a pin." //by zyf
  #endif
#endif
 ...
 */
  ...
  #elif !CUTTER_UNIT_IS(PWM255) && !CUTTER_UNIT_IS(PWM1000) && !CUTTER_UNIT_IS(PERCENT) && !CUTTER_UNIT_IS(RPM) && !CUTTER_UNIT_IS(SERVO) //by zyf
    #error "CUTTER_POWER_UNIT must be PWM255, 1000, PERCENT, RPM, or SERVO."
  #endif
  ...
  #define _PIN_CONFLICT(P) (PIN_EXISTS(P) && P##_PIN == SPINDLE_LASER_PWM_PIN)
    ...
    //#error "(SPINDLE|LASER)_FEATURE requires SPINDLE_LASER_ENA_PIN or SPINDLE_SERVO to control the power."  //by zyf we do not need ena pin.

...
#if HAS_TEMPERATURE && HAS_LCD_MENU
...
#if ANY(G38_PROBE_TARGET, CNC_COORDINATE_SYSTEMS, POWER_LOSS_RECOVERY, POWER_LOSS_RECOVERY_TL)
...
#if EITHER(SCROLL_LONG_FILENAMES, 0)

...
#define USE_NEW_WEBSERVER_VERSION         true
  ...
  #warning Use SAM_DUE architecture
       ...
       defined(STM32WB) || defined(STM32MP1) || defined(HC32F46x))
...
#include "../functional-vlpp/functional-vlpp.h"
...
class ESP8266_AT_WebServer
{
  public:
    ...
    ~ESP8266_AT_WebServer();  //delete int port by zyf

    void begin(int port=80); //add port by zyf
    void handleClient();

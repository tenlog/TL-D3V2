 ...
 */
#define E0_AUTO_FAN_PIN FAN2_PIN  //FAN2_PIN
#define E1_AUTO_FAN_PIN FAN3_PIN  //FAN3_PIN
 ...
 */
  ...
  #define X2_MAX_POS X_BED_SIZE + 47 // Set this to the distance between toolheads when both heads are homed
 ...
 */
#if ENABLED(BLTOUCH) && DISABLED(TL_W)
  ...
  #define Z_STEPPER_ALIGN_XY {{8, Y_BED_SIZE/2}, {X_BED_SIZE-8,  Y_BED_SIZE/2} }
  ...
  #define Z_STEPPER_ALIGN_ITERATIONS 3    // Number of iterations to apply during alignment // by zyf 5
  #define Z_STEPPER_ALIGN_ACC        0.05 // Stop iterating early if the accuracy is better than this // by zyf 0.02
...
//port input_shaping from 2.1.2 .. by zyf 1st testing 20231103..
// @section motion
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING //by zyf test input shaping..
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  //#define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN         POWEROFF_PIN // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
 ...
 */
  ...
  #define TOOLCHANGE_ZRAISE                 0.2 // (mm)
...
//#define SPINDLE_FEATURE
   ...
   *  - SERVO   (S0 - S180)
   */
  #define CUTTER_POWER_UNIT PWM1000
